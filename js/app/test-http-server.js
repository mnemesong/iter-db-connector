...
var testScenario = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, src_1.nodeToHttp.setVal(config, { "testk1": "test val 1" })];
            case 1:
                res1 = _a.sent();
                console.log("res1: ", res1);
                assert.ok(Object.keys(res1).includes("id"));
                assert.ok(parseInt(res1["id"]) === 0);
                return [4 /*yield*/, src_1.nodeToHttp.setVal(config, { "testk2": "test val 2" })];
            case 2:
                res2 = _a.sent();
                console.log("res2: ", res2);
                assert.ok(Object.keys(res2).includes("id"));
                assert.ok(parseInt(res2["id"]) === 1);
                return [4 /*yield*/, src_1.nodeToHttp.regIter(config)];
            case 3:
                res3 = _a.sent();
                console.log("res3: ", res3);
                assert.ok(Object.keys(res3).includes("iter"));
                iter = res3["iter"];
                return [4 /*yield*/, src_1.nodeToHttp.reqOneNewVal(config, iter)];
            case 4:
                res4 = _a.sent();
